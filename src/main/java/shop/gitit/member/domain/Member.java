...
public class Member extends BaseEntity {
    ...
    @Embedded
    @AttributeOverride(name = "githubId", column = @Column(name = "member_github_id", nullable = false))
    @AttributeOverride(name = "nickname", column = @Column(name = "member_nickname", nullable = false))
